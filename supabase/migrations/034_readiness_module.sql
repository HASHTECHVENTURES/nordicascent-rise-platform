-- Module 3: Readiness Q&A assessments (Cultural/Social + Technical, Levels 1–3)
...
-- Tests & questions: read for authenticated; write for admin
...
-- Attempts: own candidate or admin
...
-- Evaluations: admin write; candidate read own
...
-- Storage: readiness videos in documents bucket
