-- =============================================================================
-- Combined migration: Universities + Readiness Module + Mentoring
-- Run once in Supabase SQL Editor (safe to re-run — uses IF NOT EXISTS / DROP POLICY)
-- =============================================================================

-- ─── Universities & waitlist (032) ───────────────────────────────────────────
...
DO $$ BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_constraint WHERE conname = 'universities_name_type_unique'
  ) THEN
