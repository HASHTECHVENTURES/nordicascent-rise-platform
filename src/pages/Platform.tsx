...
const faqs = [
  { question: "How long does the entire process take?", answer: "The complete pipeline typically takes 6 to 12 months from initial application to successful onboarding, depending on the candidate's readiness and the employer's timeline." },
  ...
  { question: "How is the internship structured?", answer: "The internship has two phases: an official academic internship (8 to 10 weeks) and, upon a positive hire decision, a professional pre-employment engagement where the candidate begins contributing to real projects." },
];
