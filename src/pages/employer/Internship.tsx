...
export default function EmployerInternship() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-medium">Internship</h1>
        <p className="text-muted-foreground">
          Build the 6–10 week internship program for accepted candidates at {companyName}.
        </p>
      </div>

      <Card>
        <CardHeader className="flex flex-row items-center justify-between gap-4">
          <CardTitle className="text-lg">Internship tasks</CardTitle>
          {!showForm && (
