  ...
  return (
    <div className="space-y-6">
      <div className="relative overflow-hidden rounded-2xl border bg-card">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
          <div className="flex items-center gap-2 mb-2">
            ...
            <Badge className="bg-white/20 text-white border-white/30 hover:bg-white/20">Relocation</Badge>
          </div>
          <h1 className="text-2xl sm:text-3xl font-medium">Your move to the Nordics</h1>
          <p className="text-white/85 text-sm mt-1 max-w-xl">
            Step-by-step guides for visa, housing, travel, and settling in — curated by Nordic Ascent.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <p className="text-sm text-muted-foreground">
            {completedCount} of {taskList.length} guides completed
          </p>
        </div>
      ...
      {taskList.length === 0 ? (
        <Card>
          <CardContent className="py-10 text-center text-sm text-muted-foreground">
            Relocation guides are being prepared. Check back soon or contact Nordic Ascent in Messages.
          </CardContent>
        </Card>
      ) : (
