...
export type Database = {
  public: {
    ...
    Enums: {
      ...
      application_status: 'applied' | 'reviewing' | 'interview' | 'offer' | 'rejected' | 'accepted';
    };
  };
};
